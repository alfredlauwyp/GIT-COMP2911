...
public class Mailbox
{
   ...
   */
   public synchronized Message getCurrentMessage()	// Locked Method
   {
   ...
   */
   public synchronized Message removeCurrentMessage()	// Locked Method
   {
      if (newMessages.size() > 0)
   ...
   */
   public synchronized void saveCurrentMessage()		// Locked Method
   {
